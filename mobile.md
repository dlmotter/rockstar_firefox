# Install rockstar on mobile

tested on Android, not yet on iOS

1. on mobile, copy the code below. create a bookmarklet called "Installer". Paste
```js
javascript:
(function () {
...
```
2. copy the rockstar code below
3. sign in to Okta Admin
4. tap Installer. Paste. tap Install, then Close
5. rockstar is now stored for that Okta org. if you need it for another org, rinse and repeat


to create the rockstar bookmarklet:
1. create a new bookmarklet with this as the url:
```js
javascript:
eval(localStorage.rockstarSrc)
```
2. call it "rockstar"


to use:
1. on mobile, sign in to Okta Admin
2. tap the "rockstar" bookmarklet
